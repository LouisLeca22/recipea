...
import { reset, updateRecipe } from '../../features/recipes/recipeSlice';
...
function Edit() {
  ...
  const handleSubmit = async (e) => {
    ...
    const recipeData = {...formData, img, ingredients}
    dispatch(updateRecipe({recipeId: recipe._id, recipeData}));
  };
  ...
  return (
    <div className='create'>
      <h2 className='page-title'>{<FaPlus />} Modifier la recette</h2>
      <form onSubmit={handleSubmit}>
        ...
        <button className='button' style={{width: "200px"}}> Modifier !</button>
      </form>
    </div>
  );
}
